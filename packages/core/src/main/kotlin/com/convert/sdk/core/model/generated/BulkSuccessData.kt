...
import com.convert.sdk.core.model.generated.BulkEntityError
 ...
 * @param code 
 * @param message 
 * @param errors List of unprocessed entities. Would be empty, if all passed entities processed
 */
@Serializable

data class BulkSuccessData (
    ...
    val errors: kotlin.collections.List<BulkEntityError>? = null
