...
import com.convert.sdk.core.model.generated.SegmentBucketedMatchRuleAllOfMatching
import com.convert.sdk.core.model.generated.SegmentBucketedMatchRulesTypes
 ...
 *
 * @param ruleType 
 * @param `value` ID of the segment used for matching
 * @param matching 
 */
@Serializable

data class SegmentBucketedMatchRule (

    @Contextual @SerialName(value = "rule_type")
    val ruleType: SegmentBucketedMatchRulesTypes,
    ...
    val matching: SegmentBucketedMatchRuleAllOfMatching? = null
