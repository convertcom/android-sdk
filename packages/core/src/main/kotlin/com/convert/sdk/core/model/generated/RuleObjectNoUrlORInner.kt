...
import com.convert.sdk.core.model.generated.RuleObjectNoUrlORInnerANDInner
 ...
 * 
 *
 * @param AND An array of OR_WHEN-blocks.
 */
@Serializable

data class RuleObjectNoUrlORInner (

    /* An array of OR_WHEN-blocks. */
    @SerialName(value = "AND")
    val AND: kotlin.collections.List<RuleObjectNoUrlORInnerANDInner>? = null
