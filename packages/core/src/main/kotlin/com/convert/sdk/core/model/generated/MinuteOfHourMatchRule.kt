...
import com.convert.sdk.core.model.generated.MinuteOfHourMatchRuleAllOfMatching
import com.convert.sdk.core.model.generated.MinuteOfHourMatchRulesTypes
 ...
 *
 * @param ruleType 
 * @param `value` Minute of hour used for matching
 * @param matching 
 */
@Serializable

data class MinuteOfHourMatchRule (

    @Contextual @SerialName(value = "rule_type")
    val ruleType: MinuteOfHourMatchRulesTypes,
    ...
    val matching: MinuteOfHourMatchRuleAllOfMatching? = null
