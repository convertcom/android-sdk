 ...
 */
@Serializable
enum class VariationStatuses(val value: kotlin.String) {
    ...
    companion object {
         ...
         */
        fun encode(data: kotlin.Any?): kotlin.String? = if (data is VariationStatuses) "$data" else null

        /**
         * Returns a valid [VariationStatuses] for [data], null otherwise.
         */
        fun decode(data: kotlin.Any?): VariationStatuses? = data?.let {
